...
(function() {
    ...
    const welcomeScreenHTML = `
        ...
        <div class="user-registration">
            <h2 class="registration-title">Introduza os seus dados para começar a conversar</h2>
    ...
    const chatInterfaceHTML = `
        <div class="chat-body">
            ...
            <div class="chat-controls">
                <textarea class="chat-textarea" placeholder="Escreva a sua mensagem aqui..." rows="1"></textarea>
    ...
    launchButton.innerHTML = `
        ...
        <span class="chat-launcher-text">Necessita ajuda?</span>`;
