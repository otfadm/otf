...
(function() {
    ...
    // Create welcome screen with header - simplified without registration
    ...
    async function initializeChatSession() {
        ...
        try {
            ...
            // Send initial message to get bot greeting
            const initialData = {
                action: "sendMessage",
                sessionId: conversationId,
                route: settings.webhook.route,
            ...
            const messageText = Array.isArray(initialResponseData) ? 
                initialResponseData[0].output : initialResponseData.output;
    ...
    // Event listeners
    startChatButton.addEventListener('click', initializeChatSession);
